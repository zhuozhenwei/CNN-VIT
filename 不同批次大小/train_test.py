...
if __name__ == '__main__':
    ...
    data.to_excel("128.xlsx", index=True)
    # data.to_excel("64.xlsx", index=True)
    # data.to_excel("32.xlsx", index=True)
    # data.to_excel("16.xlsx", index=True)
    ...
    plt.tight_layout()
    plt.savefig("./128_train.jpg")
    # plt.savefig("./64_train.jpg")
    # plt.savefig("./32_train.jpg")
    # plt.savefig("./16_train.jpg")
    ...
    plt.tight_layout()
    plt.savefig("./128_test.jpg")
    # plt.savefig("./64_test.jpg")
    # plt.savefig("./32_test.jpg")
    # plt.savefig("./16_test.jpg")
