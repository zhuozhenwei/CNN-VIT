...
if __name__ == '__main__':
    ...
    # data.to_excel("SiLU.xlsx", index=True)
    # data.to_excel("Mish.xlsx", index=True)
    # data.to_excel("ELU.xlsx", index=True)
    # data.to_excel("PReLU.xlsx", index=True)
    data.to_excel("GELU.xlsx", index=True)
    ...
    plt.tight_layout()
    # plt.savefig("./SiLU_train.jpg")
    # plt.savefig("./Mish_train.jpg")
    # plt.savefig("./ELU_train.jpg")
    # plt.savefig("./PReLU_train.jpg")
    plt.savefig("./GELU_train.jpg")
    ...
    plt.tight_layout()
    # plt.savefig("./SiLU_test.jpg")
    # plt.savefig("./Mish_test.jpg")
    # plt.savefig("./ELU_test.jpg")
    # plt.savefig("./PReLU_test.jpg")
    plt.savefig("./GELU_test.jpg")
