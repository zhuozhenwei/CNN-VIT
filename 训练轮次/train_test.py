...
if __name__ == '__main__':
    ...
    # data.to_excel("10.xlsx", index=True)
    # data.to_excel("20.xlsx", index=True)
    # data.to_excel("30.xlsx", index=True)
    data.to_excel("40.xlsx", index=True)
    ...
    plt.tight_layout()
    # plt.savefig("./10_train.jpg")
    # plt.savefig("./20_train.jpg")
    # plt.savefig("./30_train.jpg")
    plt.savefig("./40_train.jpg")
    ...
    plt.tight_layout()
    # plt.savefig("./10_test.jpg")
    # plt.savefig("./20_test.jpg")
    # plt.savefig("./30_test.jpg")
    plt.savefig("./40_test.jpg")
