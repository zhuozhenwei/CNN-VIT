...
def train(opt):
    ...
    optimizer = optim.Adam(pg, lr=opt.lr, weight_decay=1E-2)
    # optimizer = optim.RMSprop(pg, lr=opt.lr, weight_decay=1E-2)
    # optimizer = optim.SGD(pg, lr=opt.lr, weight_decay=1E-2)
...
if __name__ == '__main__':
    ...
    # data.to_excel("AdamW.xlsx", index=True)
    data.to_excel("Adam.xlsx", index=True)
    # data.to_excel("RMSprop.xlsx", index=True)
    # data.to_excel("SGD.xlsx", index=True)
    ...
    plt.tight_layout()
    # plt.savefig("./AdamW_train.jpg")
    plt.savefig("./Adam_train.jpg")
    # plt.savefig("./RMSprop_train.jpg")
    # plt.savefig("./SGD_train.jpg")
    ...
    plt.tight_layout()
    # plt.savefig("./AdamW_test.jpg")
    plt.savefig("./Adam_test.jpg")
    # plt.savefig("./RMSprop_test.jpg")
    # plt.savefig("./SGD_test.jpg")
