...
if __name__ == '__main__':
    ...
    data.to_excel("222.xlsx", index=True)
    # data.to_excel("842.xlsx", index=True)
    ...
    plt.tight_layout()
    plt.savefig("./222_train.jpg")
    # plt.savefig("./842_train.jpg")
    ...
    plt.tight_layout()
    plt.savefig("./222_test.jpg")
    # plt.savefig("./842_test.jpg")
